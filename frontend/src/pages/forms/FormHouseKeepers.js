...
axios.post('api_form_housekeepers.php', formData);
}
...
const stepOneValidationSchema = Yup.object().shape({
	...
	dob: Yup.string().required().label('Birth date'),
	ni: Yup.string().required().label('Ni'),
	hotel: Yup.string().required().label('Hotel'),
	eligible_uk: Yup.string().required().label('Eligible'),
	permit_expiry: Yup.string().required().label('Permit expiry'),
	passport: false,
	passport_expiry: Yup.string().required().label('Passport espiry'),
	...
	emergency_contact_phone: Yup.string().required().label('Phone number'),
	...
	employment_history: Yup.array().of(Yup.object().shape({
		...
		email: Yup.string().required().label('Email'),
		start_date: Yup.string().required().label('Date'),
		finish_date: Yup.string().required().label('Date'),
	})),
	crime: false,
	crime_date: Yup.string().when('crime', {
        is: (value) => value === true,
	...
	<Form>
		...
		<FieldArray name="employment_history">
			{({ insert, remove, push }) => (
				<div>
					{formik.values.employment_history.length > 0 && formik.values.employment_history.map((i, index) => (
						<div className="row" key={index}>
							<div className="col-md-4">
								<FormikControl control='input' type='text' label='Company Name' name={`employment_history.${index}.name`} />
							</div>
							<div className="col-md-4">
							...
							<div className="col-md-6">
								<FormikControl control='date' label='Start Date' name={`employment_history.${index}.start_date`} />
							</div>
							<div className="col-md-6">
								<FormikControl control='date' label='Finish Date' name={`employment_history.${index}.finish_date`} />
							</div>
							<div className="col-md-12">
				...
				<div className="col-md-12">
        			<button type="button" className="float-end btn1" onClick={() => push({name: '', phone: '', email: '', start_date: '', finish_date: '' })}><i className='fa fa-plus'></i></button>
				</div>
			</div>)}
		</FieldArray>
		<div className="col-md-12">
		...
		<div className="col-md-4" style={{display: formik.values.crime ? 'block' : 'none'}}>
...
const stepTwoValidationSchema = Yup.object().shape({
	sign3: Yup.string().required().label('Date'),
...
<div className="row">
	...
	<div className="col-md-12">
		<FormikControl control='input' type='checkbox' label='Do you get discomfort or pain in the chest or shortness of discomfort on exercise, e.g. climbing a single flight of stairs?' name='discomfort' />
	</div>
	<div className="col-md-12">
	...
	<div className="col-md-12">
		<FormikControl control='input' type='checkbox' label='Would you have difficulty working above head height' name='head_height' />
		<p style={{margin:'-35px 0 30px'}}> (e.g. using ladders or maintenance platforms)?</p>
	</div>
	<div className="col-md-12">
