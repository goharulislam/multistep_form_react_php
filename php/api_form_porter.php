...
for($i=0; $i < $c; $i++){
    try{
        $sql = "INSERT INTO porter_employment_history (uid, company_name, phone, email) VALUES (:uid, :company_name, :phone, :email)";
        $stmt = $cn->prepare($sql);
