...
try{
$sql = "INSERT INTO form_publicareacleaner(uid, title, first_name, last_name, phone, email, address_home, post_code, work_sought, dob, ni, hotel, eligible_uk, permit_expiry, passport, passport_expiry, bank, sort_code, account_number, emergency_contact_name, emergency_contact_relation, emergency_contact_phone, emergency_contact_address, crime, crime_detail, sign1, date1, diabetes, epilepsy, blackouts, discomfort, moving, looking, outdoor, enclosed1, head_height, eyesight, lifting, accident, back, feet, hernia, bp, heart, hearing, dizziness, drugs, alcohol, sign2, name2, date2, first_name2, last_name2, phone2, address_home2, hotel2, report_to, start_date1, start_time1, job_role2, hourly_rate2, dress, medical, pregnant, emergency_name, emergency_phone, emergency_address, sign3, date3, name3, address3, hotel3, rate, payment_date, sign4, date4, name5, agency, sign5, date5, trainer_name, trainer_sign) VALUES (:uid, :title, :first_name, :last_name, :phone, :email, :address_home, :post_code, :work_sought, :dob, :ni, :hotel, :eligible_uk, :permit_expiry, :passport, :passport_expiry, :bank, :sort_code, :account_number, :emergency_contact_name, :emergency_contact_relation, :emergency_contact_phone, :emergency_contact_address, :crime, :crime_detail, :sign1, :date1, :diabetes, :epilepsy, :blackouts, :discomfort, :moving, :looking, :outdoor, :enclosed1, :head_height, :eyesight, :lifting, :accident, :back, :feet, :hernia, :bp, :heart, :hearing, :dizziness, :drugs, :alcohol, :sign2, :name2, :date2, :first_name2, :last_name2, :phone2, :address_home2, :hotel2, :report_to, :start_date1, :start_time1, :job_role2, :hourly_rate2, :dress, :medical, :pregnant, :emergency_name, :emergency_phone, :emergency_address, :sign3, :date3, :name3, :address3, :hotel3, :rate, :payment_date, :sign4, :date4, :name5, :agency, :sign5, :date5, :trainer_name, :trainer_sign)";
//echo "sql: ".$sql;
$stmt = $cn->prepare($sql);
$stmt->bindParam(':uid', $a['uid']);
