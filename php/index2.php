...
$stmt->bindParam(':disclaimer_name', $a['disclaimer_name']);
$stmt->bindParam(':disclaimer_date', $a['disclaimer_date']);
$stmt->bindParam(':gdpr_name1', $a['gdpr_name1']);
$stmt->bindParam(':gdpr_department', $a['gdpr_department']);
$stmt->bindParam(':gdpr_date1', $a['gdpr_date1']);
$stmt->bindParam(':gdpr_date2', $a['gdpr_date2']);
$stmt->bindParam(':gdpr_name2', $a['gdpr_name2']);
$stmt->bindParam(':gdpr_name3', $a['gdpr_name3']);
$stmt->bindParam(':gdpr_date3', $a['gdpr_date3']);
$stmt->bindParam(':screening_name', $a['screening_name']);
$stmt->bindParam(':screening_date_birth', $a['screening_date_birth']);
$stmt->bindParam(':screening_place_birth', $a['screening_place_birth']);
$stmt->bindParam(':approval_name1', $a['approval_name1']);
$stmt->bindParam(':approval_name2', $a['approval_name2']);
$stmt->bindParam(':approval_date', $a['approval_date']);
$stmt->bindParam(':agreement_name1', $a['agreement_name1']);
$stmt->bindParam(':agreement_name2', $a['agreement_name2']);
$stmt->bindParam(':agreement_name3', $a['agreement_name3']);
$stmt->bindParam(':agreement_name4', $a['agreement_name4']);
$stmt->bindParam(':agreement_date', $a['agreement_date']);
$stmt->bindParam(':request_name1', $a['request_name1']);
...
$stmt->bindParam(':request_name2', $a['request_name2']);
$stmt->bindParam(':request_date2', $a['request_date2']);
$stmt->bindParam(':declaration1', $a['declaration1']);
$stmt->bindParam(':declaration2', $a['declaration2']);
$stmt->bindParam(':declaration3', $a['declaration3']);
$stmt->bindParam(':declaration4', $a['declaration4']);
$stmt->bindParam(':declaration5', $a['declaration5']);
$stmt->execute();
echo "Record created.";
} catch(PDOException $e) {
echo $sql . "<br>" . $e->getMessage();
